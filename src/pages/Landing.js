...
import rightImg from '../images/sign-in.jpg'
		...
		<article className='md:flex h-screen'>
			<section className='px-10 flex flex-col items-center w-full md:w-5/12'>
				<div className='flex flex-col items-center mb-5 w-full'>
					<img className='w-1/3' src={bookImg} alt='logo' />
					...
					<div className='flex items-center w-full'>
						<hr className='border-red-600 border-1 border-solid w-10 flex-auto' />
				...
				<div className='w-full'>
					<form action='' className=' w-full'>
						...
						<button
							type='submit'
							className='w-full py-2 rounded-md border bg-lightblue-800 border-solid text-white'
						>
							Sign in
						</button>
					</form>
